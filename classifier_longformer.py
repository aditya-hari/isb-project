...
RobertaTokenizer = AutoTokenizer.from_pretrained("allenai/longformer-base-4096")
RobertaModel = AutoModel.from_pretrained("allenai/longformer-base-4096")
...
for epoch in range(EPOCHS):
    ...
    if acc > bacc:
        bacc = acc
        torch.save(model, 'longformer_classifier.pt')
    print("\n")
    print("\n")
